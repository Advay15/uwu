...
random_no=Math.floor((Math.random()*345)+1);
console.log(quick_draw_data_set[random_no]);
sketch_name=quick_draw_data_set[random_no];
document.getElementById("sketchToBeDrawn").innerHTML="Sketch to be drawn: " + sketch_name;
var time_counter=0
timer_check="";
draw_sketch="";
answer_holder="";
